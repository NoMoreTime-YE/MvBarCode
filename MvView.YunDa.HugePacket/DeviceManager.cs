...
namespace MvView.Core
{
    ...
    public class DeviceManager : IDisposable
    {
        ...
        /// 相机实例数组
        /// </summary>
        public  BarCodeCamera[] Camera
        {
            get
            {
                return _dl._BarCodeCamera;
            }
        }
        ...
        {
            MvBarCode.MvBarCodeGlobalVar.Log.Info("开始初始化相机");
            try
            {
                if (_dl == null)
                {
                ...
                {
                    // 初始化设备
                    if (_dl.Initialization(num, protocol))
                    {
                        ...
                        _dl.PicturePathHandle += this.PicturePathDelegate;
                    }
                }
            }
            catch (Exception e)
        ...
        public bool Stop()
        {
            ...
            {
                MvBarCode.MvBarCodeGlobalVar.Log.Error("Stop device exception, " + e.Message);
            }
            return retVal;
        }
        ...
        public bool Open()
        {
            MvBarCode.MvBarCodeGlobalVar.Log.Info("开始设备管理层初始化");
            if (_dl == null)
            {
                throw new InvalidOperationException();
            }
        ...
        private bool Close()
        {
            ...
            {
                MvBarCode.MvBarCodeGlobalVar.Log.Error("Close device exception, " + e.Message);
            }
            return retVal;
        }
